...
# Saved on Mon May 7 11:02:20 2018
...
set _wave_session_group_7 {Bus Signals}
...
gui_sg_addsignal -group "$_wave_session_group_7" { {V1:TOP.full_memory_u.D} {V1:TOP.full_memory_u.A} {V1:TOP.full_memory_u.SIZE} {V1:TOP.full_memory_u.RW} {V1:TOP.full_memory_u.ACK_OUT} {V1:TOP.full_memory_u.ACK_IN} }

set _wave_session_group_8 Clock
...
gui_sg_addsignal -group "$_wave_session_group_8" { {V1:TOP.clk} }

set _wave_session_group_9 {DC port}
...
gui_sg_addsignal -group "$_wave_session_group_9" { {V1:TOP.full_memory_u.DCACHE_PORT.current_state} {V1:TOP.full_memory_u.DCACHE_PORT.current_size} {V1:TOP.full_memory_u.DCACHE_PORT.data_buffer_out} }

set _wave_session_group_10 Arbitrator
...
gui_sg_addsignal -group "$_wave_session_group_10" { {V1:TOP.full_memory_u.arbitrator_u.current_state} {V1:TOP.full_memory_u.BR} {V1:TOP.full_memory_u.BG} {V1:TOP.full_memory_u.arbitrator_u.REQ} {V1:TOP.full_memory_u.arbitrator_u.DONE} }

set _wave_session_group_11 {MEM port}
...
gui_sg_addsignal -group "$_wave_session_group_11" { {V1:TOP.full_memory_u.mem_bus_controller_u.MEM_INOUT} {V1:TOP.full_memory_u.mem_bus_controller_u.current_state} {V1:TOP.full_memory_u.mem_bus_controller_u.data_buffer_out} {V1:TOP.full_memory_u.mem_bus_controller_u.rd_data_buffer_out} }

set _wave_session_group_12 {Main Memory}
...
gui_sg_addsignal -group "$_wave_session_group_12" { {V1:TOP.full_memory_u.main_memory_u.ADDR} {V1:TOP.full_memory_u.main_memory_u.WR} {V1:TOP.full_memory_u.main_memory_u.EN} {V1:TOP.full_memory_u.main_memory_u.WRITE_SIZE} {V1:TOP.full_memory_u.main_memory_u.DATA_BUF} }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ${Group5}  -item {TOP.full_memory_u.mem_bus_controller_u.MEM_INOUT[255:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 80320
