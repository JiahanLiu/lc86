...
# DVE full session
# Saved on Wed May 9 14:20:40 2018
# Designs open: 1
...
#   Group FULL MEMORY signal count = 6
...
#<Session mode="Full" path="/home/ecelrc/students/sflolid/micro/finalproj/fresh/lc86/full_simulator/session.pipeline.dump.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{65 58} {1278 611}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 491} {height 256} {dock_state left} {dock_on_new_line true} {child_hier_colhier 367} {child_hier_coltype 120} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 256
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 313} {height 256} {dock_state left} {dock_on_new_line true} {child_data_colvariable 182} {child_data_colvalue 100} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1213} {height 171} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_move "$_session_group_6" -after "$_session_group_5" -pos 5 
...
gui_sg_move "$_session_group_7" -after "$_session_group_5" -pos 4 

set _session_group_8 PIPELINE
gui_sg_create "$_session_group_8"
set PIPELINE "$_session_group_8"


set _session_group_9 ICACHE
gui_sg_create "$_session_group_9"
set ICACHE "$_session_group_9"

gui_sg_addsignal -group "$_session_group_9" { TOP.u_full_simulator.u_pipeline.u_icache.current_state TOP.u_full_simulator.u_pipeline.u_icache.RW TOP.u_full_simulator.u_pipeline.u_icache.enable TOP.u_full_simulator.u_pipeline.u_icache.addr TOP.u_full_simulator.u_pipeline.u_icache.size TOP.u_full_simulator.u_pipeline.u_icache.data_read_out TOP.u_full_simulator.u_pipeline.u_icache.ready }

set _session_group_10 DCACHE
gui_sg_create "$_session_group_10"
set DCACHE "$_session_group_10"

gui_sg_addsignal -group "$_session_group_10" { TOP.u_full_simulator.u_pipeline.u_dcache.RW TOP.u_full_simulator.u_pipeline.u_dcache.enable TOP.u_full_simulator.u_pipeline.u_dcache.addr_raw TOP.u_full_simulator.u_pipeline.u_dcache.size TOP.u_full_simulator.u_pipeline.u_dcache.ready TOP.u_full_simulator.u_pipeline.u_dcache.current_state TOP.u_full_simulator.u_pipeline.u_dcache.evict TOP.u_full_simulator.u_pipeline.u_dcache.HIT TOP.u_full_simulator.u_pipeline.u_dcache.OE TOP.u_full_simulator.u_pipeline.u_dcache.CACHE_WR TOP.u_full_simulator.u_pipeline.u_dcache.TS_WR TOP.u_full_simulator.u_pipeline.u_dcache.d_mux TOP.u_full_simulator.u_pipeline.u_dcache.tagstore_V TOP.u_full_simulator.u_pipeline.u_dcache.tagstore_D TOP.u_full_simulator.u_pipeline.u_dcache.tagstore_tag TOP.u_full_simulator.u_pipeline.u_dcache.MATCH TOP.u_full_simulator.u_pipeline.u_dcache.INVALID }

set _session_group_11 $_session_group_10|
append _session_group_11 data_u
gui_sg_create "$_session_group_11"
set DCACHE|data_u "$_session_group_11"

gui_sg_addsignal -group "$_session_group_11" { TOP.u_full_simulator.u_pipeline.u_dcache.data_u.A TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DIN TOP.u_full_simulator.u_pipeline.u_dcache.data_u.OE TOP.u_full_simulator.u_pipeline.u_dcache.data_u.WR TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DOUT TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DOUT_ARRAY TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DOUT_ARRAY0 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DOUT_ARRAY1 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DOUT_ARRAY2 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.DOUT_ARRAY3 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.a_dec TOP.u_full_simulator.u_pipeline.u_dcache.data_u.a_dec_inv TOP.u_full_simulator.u_pipeline.u_dcache.data_u.wr0 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.wr1 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.wr2 TOP.u_full_simulator.u_pipeline.u_dcache.data_u.wr3 }
...
gui_open_source -id ${Source.1}  -replace -active TOP full_sim_tb.v
gui_view_scroll -id ${Source.1} -vertical -set 115
...
gui_list_add_group -id ${Wave.1}  -after TOP.u_full_simulator.u_full_memory.RW {{FULL MEMORY|DC PORT}}
...
gui_list_collapse -id ${Wave.1} {FULL MEMORY}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group {FULL MEMORY}  -position in
