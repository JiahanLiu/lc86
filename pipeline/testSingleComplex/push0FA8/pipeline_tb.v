...
`define default_gs ((`default_reg_base_macro + 3'b101) + ((`default_reg_base_macro + 3'b101) << 8))
...
`define check_opA (`default_gs) //check values
...
/*************************** EXECUTE STAGE INPUTS COMPARE ******************************/
            ...
            if(1'b1 === `if_check_alu_result) begin
              ...
              $display("Force: alu32_result is: %h, but needs to be: %h", tb_alu_result, `alu_result);
            end
