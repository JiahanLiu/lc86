...
`define default_imm 32'h8765_431B
`define default_big_endian_imm8 8'h1B
...
`define check_opMMB (`default_mem_Value)
...
`define check_mm_data (64'hCDEF_90AB_5678_1234)
