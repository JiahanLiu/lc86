...
`define default_reg_EX_F_32 ((`default_reg_base_macro + 6) + ((`default_reg_base_macro + 6) << 8) + ((`default_reg_base_macro + 6) << 16) + ((`default_reg_base_macro + 6) << 24)) 
...
`define check_opA (`default_reg_EX_F_32) //check values
